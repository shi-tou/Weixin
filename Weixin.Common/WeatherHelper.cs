...
namespace WeiXin.Common
{
    class WeatherHelper
    {
        ...
        private static void LoadCities()
        {
            ...
            mCities.Add("101280601", new City() { Code = "101280601", Name = "深圳", PinYin = "shenzhen", FristLetter = "sz" });
            mCities.Add("101280701", new City() { Code = "101280701", Name = "珠海", PinYin = "zhuhai", FristLetter = "zh" });
            mCities.Add("101280501", new City() { Code = "101280501", Name = "汕头", PinYin = "shantou", FristLetter = "st" });
            mCities.Add("101280401", new City() { Code = "101280401", Name = "梅州", PinYin = "meizhou", FristLetter = "mz" });
            mCities.Add("101280101", new City() { Code = "101280101", Name = "广州", PinYin = "guangzhou", FristLetter = "gz" });
            mCities.Add("101280201", new City() { Code = "101280201", Name = "韶关", PinYin = "shaoguang", FristLetter = "sg" });
            mCities.Add("101300101", new City() { Code = "101300101", Name = "南宁", PinYin = "nanning", FristLetter = "nn" });
            mCities.Add("101300301", new City() { Code = "101300301", Name = "柳州", PinYin = "liuzhou", FristLetter = "lz" });
            mCities.Add("101300501", new City() { Code = "101300501", Name = "桂林", PinYin = "guiling", FristLetter = "gl" });
            mCities.Add("101300801", new City() { Code = "101300801", Name = "贵港", PinYin = "guigang", FristLetter = "gg" });
            mCities.Add("101300901", new City() { Code = "101300901", Name = "玉林", PinYin = "yuling", FristLetter = "yl" });
        }
        /// <summary>
        /// 获取城市的天气
        /// </summary>
